...
# echo "ALPHA => 0.5"
# python main.py fedavg -e 5 -k 5 -t 40 --distill kl --seed 420 -b 64  --base ./models/remote-03/ --alpha 0.3 --lr 1e-3
# python main.py fedavg -e 5 -k 5 -t 40 --distill kl --seed 69  -b 64 --base ./models/remote-03/ --alpha 0.3 --lr 1e-3
# python main.py fedavg -e 5 -k 5 -t 40 --distill kl --seed 42  -b 64 --base ./models/remote-03/ --alpha 0.3 --lr 1e-3
...
# echo "ALPHA => 0.03"
# python main.py fedavg -e 5 -k 5 -t 40 --distill kl --seed 420 -b 64 --base ./models/remote-003/  --alpha 0.03 --lr 1e-3
# python main.py fedavg -e 5 -k 5 -t 40 --distill kl --seed 69  -b 64 --base ./models/remote-003/ --alpha 0.03 --lr 1e-3
# python main.py fedavg -e 5 -k 5 -t 40 --distill kl --seed 42  -b 64 --base ./models/remote-003/ --alpha 0.03 --lr 1e-3
...
# python main.py fedad -e 250 -k 5 -t 10 --distill kl --seed 420 -b 512 --base ./models/five-resnet-alpha-0_5/ --alpha 0.5 --lr 1e-3 --use-test-loader true
# python main.py fedad -e 250 -k 5 -t 10 --distill kl --seed 69 -b 512 --base ./models/five-resnet-alpha-0_5/ --alpha 0.5 --lr 1e-3 --use-test-loader true
# python main.py fedad -e 250 -k 5 -t 10 --distill kl --seed 42 -b 512 --base ./models/five-resnet-alpha-0_5/ --alpha 0.5 --lr 1e-3 --use-test-loader true

# python main.py fedad -e 250 -k 5 -t 10 --distill kl --seed 420 -b 512 --base ./models/remote-03/ --alpha 0.3 --lr 1e-3 --use-test-loader true
# python main.py fedad -e 250 -k 5 -t 10 --distill kl --seed 69 -b 512 --base ./models/remote-03/ --alpha 0.3 --lr 1e-3 --use-test-loader true
# python main.py fedad -e 250 -k 5 -t 10 --distill kl --seed 42 -b 512 --base ./models/remote-03/ --alpha 0.3 --lr 1e-3 --use-test-loader true

# python main.py fedad -e 250 -k 5 -t 10 --distill kl --seed 420 -b 512 --base ./models/remote-005/ --alpha 0.05 --lr 1e-3 --use-test-loader true
# python main.py fedad -e 250 -k 5 -t 10 --distill kl --seed 69 -b 512 --base ./models/remote-005/ --alpha 0.05 --lr 1e-3 --use-test-loader true
# python main.py fedad -e 250 -k 5 -t 10 --distill kl --seed 42 -b 512 --base ./models/remote-005/ --alpha 0.05 --lr 1e-3 --use-test-loader true

# python main.py fedad -e 250 -k 5 -t 10 --distill kl --seed 420 -b 512 --base ./models/remote-003 --alpha 0.03 --lr 1e-3 --use-test-loader true
# python main.py fedad -e 250 -k 5 -t 10 --distill kl --seed 69 -b 512 --base ./models/remote-003 --alpha 0.03 --lr 1e-3 --use-test-loader true
# python main.py fedad -e 250 -k 5 -t 10 --distill kl --seed 42 -b 512 --base ./models/remote-003 --alpha 0.03 --lr 1e-3 --use-test-loader true
...
python main.py train -e 200 -k 5 -b 16 -t 20 --data fmnist --alpha 0.5 --base ./models/fmnist-05 --distill kl --lr 0.001 --seed 42
python main.py train -e 200 -k 5 -b 16 -t 20 --data fmnist --alpha 0.3 --base ./models/fmnist-03 --distill kl --lr 0.001 --seed 42
python main.py train -e 200 -k 5 -b 16 -t 20 --data fmnist --alpha 0.05 --base ./models/fmnist-005 --distill kl --lr 0.001 --seed 42
python main.py train -e 200 -k 5 -b 16 -t 20 --data fmnist --alpha 0.03 --base ./models/fmnist-003 --distill kl --lr 0.001 --seed 42
